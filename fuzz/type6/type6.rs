...
fuzz_target!(|data: DctArbitrary| {
    ...
    let dct1 = Pxdct::make_dst6_f32(len).unwrap();
    let dst1 = Pxdct::make_dst6_f32(len).unwrap();
    ...
    let dct1 = Pxdct::make_dst6_f64(len).unwrap();
    let dst1 = Pxdct::make_dst6_f64(len).unwrap();
